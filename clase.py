...
class UrbanRoutesPage:
    ...
    #SMS_FIELD = (By.TAG_NAME, 'code')
    #SMS_CODE = retrieve_phone_code(driver)
    ...
    def click_comfort_button(self):
        #WebDriverWait(self.driver,5).until(expected_conditions.presence_of_element_located((By.CLASS_NAME, 'tariff-picker shown')))
    ...
    def sms_code(self):
        new_code_click= WebDriverWait(self.driver,60).until(expected_conditions.element_to_be_clickable(self.SEND_NEW_CODE))
        new_code_click.click()
